# 1 - Infographic Database {#infographic-database}
###Spreading Knowledge, One Infographic at a Time

#### Keywords

infographic, database, integrity, social media, knowledge, facts

## Underused Value of Research
...
```{r good-infographics,echo=FALSE,fig.cap='An infographic describing infographic best practices.',fig.align='center',out.width='80%'}
...
```{r infographic-types,echo=FALSE,fig.cap='A satirical infographic outlining a variety infographic types.',fig.align='center',out.width='80%'}
